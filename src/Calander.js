...
function Calander()
{
    ...
    return (
        ...
        <h2 className="month-header" style={{marginLeft:'-500px',marginTop:'15px' ,fontSize:'40px',color:'Brown'}}>3 MARCH {currentYear} </h2>
        <h2 style={{ marginTop: '-55px', marginLeft: '750px', fontSize: '40px', color: 'maroon', marginBottom: '0px' }}>હરિધામ,સોખડા-39174,જી.વડોદરા.</h2>
        <h3 className="s2080" style={{  marginLeft: '-758px',fontSize:'28px',color:'brown',marginTop:'10px' }}>સંવત 2080 </h3>
            ...
            }
            {
                ...
                
                {
                    return  <div style={{width: '950px'}}>
                        <Box date={date1.date} tithi={date1.tithi} other={date1.other} image={date1.image} colorBox={date1.colorBox}/>
                    </div>
                })
            }
